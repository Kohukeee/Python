...
#mitu kingitust jääb üle. Kasuta täisarvulist jagamist (//) kinkekarpide
#arvu leidmiseks ja jäägi (%) operaatorit ülejäävate kingituste arvu leidmiseks.
...
try:
    ...
    print(f"Saad teha {kingitused} täis kinkekasti. Üle jääb {ylejaak} kingitust.")
except:
...
#Kirjuta programm, mis küsib kasutajalt soovitud raamatute arvu ja
#arvutab nende kogumaksumuse, kui iga raamatu tavahind on 12,53€.
