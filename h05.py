...
# Programm genereerib juhusliku tulemuse – “kiri” või “kull”,
# kasutades random.randint(0,1) funktsiooni.
# Programmi koostamisel pead importima import random mooduli ja kasutama randint() funktsiooni,
# et valida kahe võimaliku tulemuse vahel.
# Näiteks, kui randint(0, 1) annab tulemuseks 0, siis võib see tähendada “kirja”,
# ja 1 võib tähendada “kulli”.
...
# # Kirjuta programm, mis kontrollib kasutaja poolt sisestatud
# vastust lihtsale matemaatikaülesandele.
# # Näiteks, programm esitab küsimuse “Mis on 3 korda 4?”.
# Kasutaja peab sisestama vastuse. Kui kasutaja vastus on 12, siis
# programm väljastab “Õige vastus!”, kui aga vastus on midagi muud,
...
# #Sa oled loomas programmi, mis aitab kontrollida, kas inimesed vastavad
# vanusepiirangu nõuetele üritusel osalemiseks.
# #Programm palub kasutajal sisestada oma vanuse. Kui vanus on vähemalt 18 aastat,
# siis programm annab teada, et kasutaja võib üritusele siseneda.
